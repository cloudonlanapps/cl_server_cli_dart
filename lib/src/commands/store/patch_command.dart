...
/// Execute store patch command
Future<void> runStorePatchCommand(ArgResults args, CLIContext context) async {
  ...
  try {
    final result = await manager.patchEntity(
      entityId!,
      label: label,
    ...
    if (!result.isSuccess || result.data == null) {
      outputError(context, result.error ?? 'Failed to patch entity');
    }
